...
standard_cards = [
	TACard('Tim Tu, Tuner of Two Tubas', 2200, 1200),
	TACard('λaryn, λord of λambdas', 1800, 1600),
	TACard('Addison, from operator import add', 2000, 1200),
	TutorCard('Maanav, Recursive Royal', 2000, 1400),
	TACard('Ben, Paladin of Penguins and Turtles', 1600, 1700),
	TutorCard('Kevin, writer of inefficient code, the destroyer of worlds', 1500, 1700),
	TutorCard('Kendrick, Local Gardener', 2100, 1100),
	TACard('Grace, Ramen Fairy', 1000, 2400),
	AICard('Eric, the Hollow Knight', 1500, 1600),
	AICard('Sanjay, the Juicer of Lemons', 1001, 2299),
	AICard('Hans, the king of debugger', 1900, 1500),
	AICard('Rebecca, the Patron of Fangirls', 1200, 1700),
	AICard('Reuben, the Bringer of Chaos and Nuggets', 1500, 1500),
	...
	AICard('Julia, the Summoner of Chipotle', 2300, 1100),
	AICard('Sameer, Disciple of Hilfinger', 1200, 1600),
	AICard('Sepehr the Pear', 1100, 2000),
	AICard('Karim, Sayer of Many, Doer of None', 1700, 1600),
	TACard('John, Generator of Generators', 1200, 2000),
	AICard('Yoisaki Kanade, The Only Waifu', 1500, 1700),
	AICard('Sid, User of Murphys Law', 2300, 1000),
	AICard('Phillip, the Pyro Primate', 2100, 1300),
	AICard('Michael, the Master of Mozzarella', 2000, 1300),
	AICard('Ashley, Coffee Connoisseur', 1500, 1600),
	TACard('Jamie the Imaginary', 1200, 2100),
	AICard('Aarin, the Analyst ', 1500, 1500),
	AICard('Ritik, Earth Crusher', 2100, 1200),
	AICard('Christopher, the Fatigued Foe', 1600, 1700),
	...
	TACard('Charlotte, Shawarma Sharpshooter', 2400, 1000),
	TutorCard('Mingxiao, QwQ', 1500, 1600),
	...
	TutorCard('Bryce, Circle Annihilator', 1500, 1500),
